import pytest
from ns_llm.structured.providers.openrouter_provider import call_openrouter_structured
...
def test_fallback_prompt_injection(monkeypatch):
    ...
    monkeypatch.setattr(
        "ns_llm.structured.providers.openrouter_provider.generate_response",
        fake_generate,
    )

    result = call_openrouter_structured(**API_PARAMS)
